<template>
  <div>
    <div :class="isDarkMode ? 'dark toolbar' : 'toolbar'">
      <div class="header-title">组态软件</div>
      <div class="header-Box">
        <div @click="onShowclikc('file')">文件</div>
        <div @click="onShowclikc('edit')">编辑</div>
        <div @click="onShowclikc('view')">视图</div>
        <div @click="onShowclikc('setup')">设置</div>
        <div @click="onShowclikc('window')">窗口</div>
        <div @click="onShowclikc('help')">帮助</div>
      </div>
      <div class="alter-btnbox"></div>
      <div style="padding-left: 10px; padding-bottom: 10px">
        ...
        <el-button style="margin-left: 10px" @click="yulan({ name: 'analogModule' })"> 预览 </el-button>
